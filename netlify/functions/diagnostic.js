...
<div style="max-width:600px;margin:24px auto;background:#fff;border-radius:12px;overflow:hidden;">
  ...
  <div style="padding:32px;">
    ...
    ${!isAdmin
      ? `<div style="text-align:center;background:#0A0A0A;border-radius:12px;padding:24px;"><div style="font-size:16px;font-weight:700;color:#fff;margin-bottom:8px;">PRÓXIMO PASSO</div><div style="font-size:13px;color:#888;margin-bottom:16px;line-height:1.6;">O diagnóstico identifica o gargalo. A arquitetura define como resolver.</div><a href="https://wa.me/5511974270077?text=Olá%20Fábio%2C%20acabei%20de%20fazer%20o%20diagnóstico%20da%20ScaleCo%20e%20gostaria%20de%20conversar." style="display:inline-block;background:#25D366;color:#fff;text-decoration:none;border-radius:8px;padding:12px 32px;font-weight:700;font-size:14px;">AGENDAR CALL COM FÁBIO</a></div>`
